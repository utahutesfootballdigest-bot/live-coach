...
STAGE_SCRIPT: dict[str, list[str]] = {
    "intro": [
        ...
        "Perfect, well I'll be the one to walk you through the process and help you get set up. Have you ever had a security system before?",
    ],
    "discovery": [
        ...
        "Who all are we looking to protect — is it just you or is there anyone else living there with you?",
        "[If kids] Are we talking about little kids or teenagers?",
        "What has you looking to get security? Did something happen, did you just move, what's going on?",
        "I'll make sure we take great care of you and get you fully protected.",
    ],
    "collect_info": [
        "Well let me get some information from you so I can help you get set up. Could you please give me your first and last name?",
        "And what's the best phone number for you, [NAME]?",
        "And what's a good email address for you?",
        "I do just want to verify that we have coverage, [NAME] — what's the address you're looking to get the security set up at?",
        "Awesome, [NAME], so we do have fantastic coverage there so we can definitely help you out. Let's go ahead and dive right in.",
    ],
    "build_system": [
        "How many doors go in and out of your house?",
        "[After customer answers doors] [EXACT NUMBER] doors, okay so I'm gonna get you [EXACT NUMBER] door sensors that way all those doors are covered for you. And then how many ground-floor windows do you have?",
        "How many ground-floor windows do you have?",
        "[After customer answers windows] [EXACT NUMBER] windows, so I'm gonna get you [EXACT NUMBER] window sensors. And just so you know, [NAME], with all those door and window sensors, obviously when the system's armed anyone opens any of them it'll sound the alarm, but the cool thing is even when the system's unarmed it'll have the chime feature — that's the thing that says 'front door open', 'bedroom window open' — so you'll always know what's going on in your house. Does that make sense?",
        "I'm also gonna get you a free indoor camera with the system — live HD recording, night vision, two-way audio with a motion sensor. So no matter where you are you're gonna have eyes on the inside of your house, [NAME]. I'm also gonna get you a 7-inch color touchscreen panel — this is what connects your system to the cellular network and runs everything, so if the power goes out or the Wi-Fi goes down your home's still protected. We're also gonna get you 24/7 live monitoring for police, medical, and fire — so no matter what the situation is, [NAME], we've got you covered. And there's a two-way speaker inside the panel, so if the alarm goes off and we can't get ahold of you over the phone, we can reach out right over the speaker to make sure you're okay. Does that all make sense?",
        "I'm also gonna get you a yard sign for the front yard and some window stickers to put in the windows — that way if it's a random break-in and they're just picking a random house, they'll be less likely to pick yours. And you'll have smartphone access to everything — you can arm and disarm the system through your phone, pull up the cameras, speak through them, basically you'll have full access to run everything no matter where you are.",
        "Would you like to add a smoke detector or any additional cameras to the system?",
    ],
    "recap": [
        "Let me recap everything real quick, [NAME]. We've got [list door sensors, window sensors, indoor camera, touchscreen panel, yard sign, window stickers, and smartphone access]. Personally I think we've got you fully covered here — was there anything else you were hoping I could throw in there for you?",
    ...
    "closing": [
        ...
        "Then I'm gonna get you a bunch of extra discounts here. On the monthly monitoring cost, that'll just be ___ per month. The equipment we have for you would usually cost $600, but I'm gonna get your total equipment cost today all the way down to just ___. So to get you set up today, all you'll have to do is pay the ___ for the equipment, and from then on it'll just be ___ per month.",
        "Does that sound like it will work for you, [NAME]?",
        "Congratulations and welcome to the Cove family! You'll get tracking information as soon as your package ships. Once your equipment arrives, you'll find simple step-by-step setup instructions inside. If you need help, our customer service team is just a call away.",
    ],
}

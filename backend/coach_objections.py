...
OBJECTION_REBUTTALS = {
    ...
    "equipment_pricing": {
        "signals": [
            "how much is the outdoor", "how much is an outdoor", "how much are the outdoor",
            "how much is the doorbell", "how much is a doorbell", "how much are the doorbell",
            "how much is the camera", "how much are the cameras", "how much is a camera",
            "how much is the motion", "how much is a motion", "how much are motion",
            "how much is the smoke", "how much is a smoke",
            "how much for the outdoor", "how much for the doorbell", "how much for a camera",
            "how much for the camera", "how much for two", "how much for three",
            "price on the outdoor", "price on the camera", "price on the doorbell",
            "price for the outdoor", "price for the camera", "price for the doorbell",
            "cost of the outdoor", "cost of the camera", "cost of the doorbell",
            "what does the outdoor camera cost", "what does the doorbell cost",
            "what do the cameras cost", "what does the camera cost",
            "pricing for outdoor", "pricing for camera", "pricing on outdoor",
            "how much would two outdoor", "how much would two camera",
            "how much extra for", "what's the price on",
        ],
        "stages": ["build_system", "closing", "recap"],
        "type": "Equipment Pricing Question",
        "summary": "Customer wants to know specific equipment pricing",
        "suggestions": [{"label": "Equipment Prices", "text": "Great question! Here are our current prices with the promotion: Outdoor solar camera is $79.99 (regularly $159.99). Doorbell camera is $49.99 (regularly $99.99). Indoor camera — your first one is free! Motion detector is $25 (regularly $50). Smoke detector is $47.50 (regularly $95). Key fob is $15 (regularly $30). Door and window sensors are $7.50 each (regularly $15). Would you like to add any of those?"}],
        "transitions": ["Would you like to add that to your system?", "How many would you like?", "Would you like me to add those to your cart?"],
    },
    "upfront_cost": {
        "signals": [
